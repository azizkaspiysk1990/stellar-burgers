...
import type { RootState } from '../store'; // импорт типа RootState для селекторов
...
// Селекторы: обращаемся к состоянию под ключом 'ingredients' (именно так задано в combineReducers)
